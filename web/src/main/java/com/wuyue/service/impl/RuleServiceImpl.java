...
//            // 湿度
//            if (splitParam[count].equals(HUMIDITY.getParamName())) {
//                // 如果温度最小值为-20,则添加一条条件: temp<data.max
//                if (min == 0) {
//                    Conditions realCondition = new Conditions(null, HUMIDITY.getParamName(), LT, max, ruleList.getId());
//                    insertedConditions += conditionsMapper.insert(realCondition);
//                }
//                // 如果温度最大值为50,则添加一条条件: temp>data.min
//                if (max == 100) {
//                    Conditions realCondition = new Conditions(null, HUMIDITY.getParamName(), GT, min, ruleList.getId());
//                    insertedConditions += conditionsMapper.insert(realCondition);
//                }
//                if (min != 0 && max != 100) {
//                    Conditions realCondition1 = new Conditions(null, TEMPERATURE.getParamName(), LT, max,
//                            ruleList.getId());
//                    Conditions realCondition2 = new Conditions(null, TEMPERATURE.getParamName(), GT, min,
//                            ruleList.getId());
//                    insertedConditions += conditionsMapper.insert(realCondition1);
//                    insertedConditions += conditionsMapper.insert(realCondition2);
//                }
...
//
//            // 亮度
//            if (splitParam[count].equals(LIGHT.getParamName())) {
//                // 如果温度最小值为-20,则添加一条条件: temp<data.max
//                if (min == 0) {
//                    Conditions realCondition = new Conditions(null, LIGHT.getParamName(), LT, max, ruleList.getId());
//                    insertedConditions += conditionsMapper.insert(realCondition);
//                }
//                // 如果温度最大值为50,则添加一条条件: temp>data.min
//                if (max == 30000) {
//                    Conditions realCondition = new Conditions(null, LIGHT.getParamName(), GT, min, ruleList.getId());
//                    insertedConditions += conditionsMapper.insert(realCondition);
//                }
//                if (min != 0 && max != 30000) {
//                    Conditions realCondition1 = new Conditions(null, TEMPERATURE.getParamName(), LT, max,
...
//
//            // 气压
//            if (splitParam[count].equals(PRESSURE.getParamName())) {
//                // 如果温度最小值为-20,则添加一条条件: temp<data.max
//                if (min == 900) {
//                    Conditions realCondition = new Conditions(null, PRESSURE.getParamName(), LT, max * 100, ruleList.getId());
//                    insertedConditions += conditionsMapper.insert(realCondition);
//                }
//                // 如果温度最大值为50,则添加一条条件: temp>data.min
//                if (max == 1200) {
//                    Conditions realCondition = new Conditions(null, PRESSURE.getParamName(), GT, min * 100,
//                            ruleList.getId());
//                    insertedConditions += conditionsMapper.insert(realCondition);
//                }
//                if (min != 900 && max != 1200) {
